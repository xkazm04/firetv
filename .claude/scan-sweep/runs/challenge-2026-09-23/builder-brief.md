# Builder brief - /scan-sweep --challenge, run challenge-2026-09-23

- Tree: `C:/Users/kazda/kiro/firetv-challenge` - a git worktree on branch `scan-sweep/challenge-2026-09-23`.
  **Commit on this branch. Never push. Never switch branches. Never touch `C:/Users/kazda/kiro/firetv`** (the
  operator's main checkout; its dev server holds real learner data).
...
- Method (long form): `C:/Users/kazda/kiro/ai-registry/skills/scan-sweep/references/challenge.md` section 7.

## Your card
Read your card from `.claude/scan-sweep/runs/challenge-2026-09-23/cards/<host>.json`, the slot named in your
...
5. **Commit as a short series, each commit green:** `test(<ctx>): <cases>` then `feat|refactor(<ctx>): <title>`.
...
Write `.claude/scan-sweep/runs/challenge-2026-09-23/results/<host>-<slot letter>.json` with the Write tool:
